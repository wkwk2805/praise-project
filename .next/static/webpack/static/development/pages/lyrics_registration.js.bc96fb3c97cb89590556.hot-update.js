...
var getAxiosData = function getAxiosData(payload) {
  return axios__WEBPACK_IMPORTED_MODULE_2___default.a.put("http://localhost:3001/api/".concat(payload));
}; // dispatch => checking =>
    ...
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _context.prev = 0;
          _context.next = 3;
          return Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_1__["call"])(getAxiosData, action.payload);

        case 3:
          data = _context.sent;
          _context.next = 6;
          return Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_1__["put"])(Object(_lyrics__WEBPACK_IMPORTED_MODULE_3__["axiosResult"])(data));
...
//# sourceMappingURL=lyrics_registration.js.bc96fb3c97cb89590556.hot-update.js.map