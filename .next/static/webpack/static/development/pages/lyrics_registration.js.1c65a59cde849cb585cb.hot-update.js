...
var Registration = function Registration() {
  ...
  var insertData = function insertData(e) {
    setData(Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_1__["default"])({}, data, Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])({}, e.target.name, e.target.value))); // 들어온 값을 데이터 베이스로 넘기기

    var register = function register(e) {
      e.preventDefault();
      e.target.value === "" && delete data[e.target.name];
    };
...
//# sourceMappingURL=lyrics_registration.js.1c65a59cde849cb585cb.hot-update.js.map