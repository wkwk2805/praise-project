...
var LyricsList = function LyricsList(_ref) {
  ...
  function () {
    ...
    _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
      var _window, innerHeight, scrollHeight, scrollTop, val, res, arr;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 7:
              ...
              if (size !== lyrics.length - 1) {
                arr = lyrics.map(function (e) {
                  return e;
                });
                arr.push(res.data);
                setLyrics(lyrics.concat(res.data[0]));
...
//# sourceMappingURL=lyrics_list.js.551053fdc63d960c562b.hot-update.js.map