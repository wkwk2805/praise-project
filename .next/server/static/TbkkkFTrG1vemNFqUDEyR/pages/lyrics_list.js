...
module.exports = __webpack_require__("C6AP");
...
// CONCATENATED MODULE: ./components/LyricsList.js
...
var LyricsList_LyricsList = function LyricsList(_ref) {
  var data = _ref.data;
  var select = Object(external_react_redux_["useSelector"])(function (state) {
    return state.select;
  });

  var _useState = Object(external_react_["useState"])(data),
  ...
  var dispatch = Object(external_react_redux_["useDispatch"])(); // init
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 7;
              return external_axios_default.a.get("http://localhost:3001/api/scroll?first=" + (lyrics.length - 1));
  ...
  var createPpt = function createPpt() {
    ...
    router_default.a.push("/lyrics_check_view?" + str);
  };
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              _context2.next = 3;
              return dispatch(Object(sagas["c" /* selectData */])(encodeURI(e.target.value)));
  ...
  return external_react_default.a.createElement(external_react_default.a.Fragment, null, external_react_default.a.createElement(Layout["a" /* default */], {
    title: "\uAC00\uC0AC\uBAA9\uB85D\uD398\uC774\uC9C0"
    ...
    }, e.title + " " + (e.code ? "(".concat(e.code, ")") : "")))), external_react_default.a.createElement("p", {
      className: "jsx-3632274245" + " " + "card-text txt_line_content"
    }, e.contents[0].statement), external_react_default.a.createElement("button", {
      style: {
        float: "left"
      },
  ...
  }, "\uAC00\uC0AC \uC81C\uBAA9"), external_react_default.a.createElement("p", {
    className: "jsx-3632274245"
    ...
    }, el.title + " " + el.code, external_react_default.a.createElement("i", {
      style: {
        color: "red",
        cursor: "pointer",
        float: "right",
  ...
  }, "PPT \uC0DD\uC131"), external_react_default.a.createElement("p", {
    className: "jsx-3632274245"
  }), external_react_default.a.createElement("button", {
    onClick: downloadFiles,
    className: "jsx-3632274245" + " " + "btn btn-primary"
  }, "\uC545\uBCF4\uB2E4\uC6B4\uB85C\uB4DC"))))), external_react_default.a.createElement(style_default.a, {
    id: "3632274245"
...
/* harmony default export */ var components_LyricsList = (LyricsList_LyricsList);
// CONCATENATED MODULE: ./pages/lyrics_list.js
...
var lyrics_list_lyrics_list = function lyrics_list(_ref) {
  var data = _ref.data;
  Object(external_react_["useEffect"])(function () {
    if (data.length === 0) {
      alert("검색된 내용이 없습니다.");
  ...
  return external_react_default.a.createElement(components_LyricsList, {
    data: data
  });
}; // init


lyrics_list_lyrics_list["getInitialProps"] =
/*#__PURE__*/
function () {
  var _ref2 = Object(asyncToGenerator["a" /* default */])(
  /*#__PURE__*/
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return req.query.value ? external_axios_default.a.get("http://localhost:3001/api/search?info=" + param) : external_axios_default.a.get("http://localhost:3001/api");
...
/* harmony default export */ var pages_lyrics_list = __webpack_exports__["default"] = (lyrics_list_lyrics_list);
