...
var CheckView = function CheckView(_ref) {
  ...
  var open_view = function open_view() {
    openView = open("./lyrics_view?id=" + _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_1___default()(id) + "&init=" + document.getElementsByClassName("active")[0].id, "_blank", "toolbar=yes,scrollbars=yes,resizable=yes,width=1080,height=800");
  };
...
//# sourceMappingURL=lyrics_check_view.js.177dcfdf7ffc538890c5.hot-update.js.map