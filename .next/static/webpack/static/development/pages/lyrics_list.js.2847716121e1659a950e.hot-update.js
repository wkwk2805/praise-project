...
var LyricsList = function LyricsList(_ref) {
  ...
  function () {
    ...
    _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {
      var res1, _window, innerHeight, scrollHeight, scrollTop, _val, res;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 2:
              ...
              _val = inputRef.current.value;
              _context.next = 11;
              return axios__WEBPACK_IMPORTED_MODULE_10___default.a.get("".concat(_util_hostname__WEBPACK_IMPORTED_MODULE_11__["default"], "/api/scroll?info=").concat(_val, "&first=").concat(lyrics.length - 1), {
                withCredentials: true
              });
  ...
  var checkboxHandler = function checkboxHandler(e) {
    if (e.target.checked) {
      var _val2 = e.target.value.split("#");

      var id = e.target.id;
      setChecked(checked.concat({
        id: id,
        title: _val2[0],
        code: _val2[1] !== "undefined" ? "(".concat(_val2[1], ")") : "",
        file: _val2[2] !== "undefined" ? _val2[2] : ""
      }));
    } else {
      var _id = e.target.id;
...
//# sourceMappingURL=lyrics_list.js.2847716121e1659a950e.hot-update.js.map