  ...
  }))), contentsHandler(data).map(function (e) {
    {
      ...
      e.contents.forEach(function (item) {
        console.log("item", item);
        {
          ...
          <div className="lyr-title">{e.title}</div>
          <div>{item}</div>
          </div>; */
        }
...
//# sourceMappingURL=lyrics_check_view.js.cfbde42e9f6e7cf97f9f.hot-update.js.map