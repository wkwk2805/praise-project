...
var lyrics = __webpack_require__("VQQa");

// EXTERNAL MODULE: ./modules/async.js
var modules_async = __webpack_require__("8y3x");

// EXTERNAL MODULE: ./modules/select.js
var modules_select = __webpack_require__("hbbg");
...
var rootReducer = Object(external_redux_["combineReducers"])({
  lyrics: lyrics["b" /* default */],
  async: modules_async["c" /* default */],
  select: modules_select["a" /* default */]
});
...
var sagaMiddleware = external_redux_saga_default()(); // redux-saga와 store연결

var store = Object(external_redux_["createStore"])(modules, Object(external_redux_["applyMiddleware"])(sagaMiddleware)); // redux-saga에 rootSaga연결

sagaMiddleware.run(sagas["a" /* default */]);
