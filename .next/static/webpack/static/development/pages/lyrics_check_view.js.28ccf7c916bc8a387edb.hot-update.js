...
var contentsHandler = function contentsHandler(data) {
  ...
  contents.forEach(function (item, i) {
    ...
    item.forEach(function (item2) {
      var item2Arr = item2.statement.split("\n");
      item2Arr.forEach(function (item3, i) {
        if (i % 2 !== 0) {
          console.log("i%2 !== 0", item3);
        } else {
          console.log("i%2 === 0", item3);
        }
      });
...
//# sourceMappingURL=lyrics_check_view.js.28ccf7c916bc8a387edb.hot-update.js.map