...
var LyricsList = function LyricsList(_ref) {
  ...
  var downloadFiles = function downloadFiles() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_6___default()("http://localhost:3001/api/downloads").then(function (res) {
      console.log(res);
      res.data.forEach(function (item, i) {
        zip.file(item, "example" + i);
      });
      zip.generateAsync({
        type: "blob"
      }).then(function (blob) {
        return Object(file_saver__WEBPACK_IMPORTED_MODULE_8__["saveAs"])(blob, "exmple.zip");
      }).catch(function (e) {
...
//# sourceMappingURL=lyrics_list.js.933f7d43b06f65f5db26.hot-update.js.map