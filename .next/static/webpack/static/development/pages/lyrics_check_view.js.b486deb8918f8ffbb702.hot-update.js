...
var CheckView = function CheckView(_ref) {
  ...
  var change_data = function change_data(e) {
    if (openView) {
      console.log(openView.document); //openView.document.getElementById("data").value = JSON.stringify({ main: 1, sub: 1 });
    }
...
//# sourceMappingURL=lyrics_check_view.js.b486deb8918f8ffbb702.hot-update.js.map