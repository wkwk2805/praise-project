...
var CheckView = function CheckView(_ref) {
  ...
  var change_data = function change_data(e) {
    if (openView) {
      console.log(openView); //openView.document.getElementById("data").value = JSON.stringify({ main: 1, sub: 1 });
    }
...
//# sourceMappingURL=lyrics_check_view.js.d939a362752dbffc2128.hot-update.js.map