...
var UpdateDisplay = function UpdateDisplay(_ref) {
  ...
  var onChangeHandler = function onChangeHandler(e) {
    if (e.target.type === "file") {
      e.target.value = e.target.value.split(/\\/)[2];
    }

    setInfo(Object(_babel_runtime_corejs2_helpers_esm_objectSpread__WEBPACK_IMPORTED_MODULE_1__["default"])({}, info, Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])({}, e.target.name, e.target.type === "file" ? e.target.value.split(/\\/)[2] : e.target.value)));
  };
...
//# sourceMappingURL=lyrics_update_display.js.812742428b3aba07d5b8.hot-update.js.map