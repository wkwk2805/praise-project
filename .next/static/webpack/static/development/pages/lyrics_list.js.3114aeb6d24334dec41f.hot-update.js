...
/*!**************************!*\
  !*** ./modules/sagas.js ***!
  \**************************/
/*! exports provided: insertData, updateData, deleteData, selectData, scrollData, rootSaga, default */
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "scrollData", function() { return scrollData; });
...
_babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(getAxiosData),
    _marked3 =
/*#__PURE__*/
_babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(getScrollData),
    _marked4 =
/*#__PURE__*/
...
var SELECT_SCROLL = "sagas/SELECT_SCROLL";
...
var scrollData = function scrollData(first) {
  return {
    type: SELECT_SCROLL,
    payload: "get",
    first: first
...
var scrollAxiosData = function scrollAxiosData(first) {
  return axios__WEBPACK_IMPORTED_MODULE_2___default.a.get("http://localhost:3001/api/scroll?first=" + first);
}; // dispatch => checking =>
...
function getScrollData(action) {
  var _res2;

  return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function getScrollData$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          _context3.prev = 0;
          _context3.next = 3;
          return scrollAxiosData(action.first);

        case 3:
          _res2 = _context3.sent;
          _context3.next = 6;
          return Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_1__["put"])(Object(_select__WEBPACK_IMPORTED_MODULE_4__["getData"])(_res2));
...
function axiosSaga() {
  return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function axiosSaga$(_context4) {
    while (1) {
      switch (_context4.prev = _context4.next) {
        ...
        case 8:
          _context4.next = 10;
          return Object(redux_saga_effects__WEBPACK_IMPORTED_MODULE_1__["takeEvery"])(SELECT_SCROLL, getScrollData);
...
function rootSaga() {
  return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function rootSaga$(_context5) {
    while (1) {
...
//# sourceMappingURL=lyrics_list.js.3114aeb6d24334dec41f.hot-update.js.map