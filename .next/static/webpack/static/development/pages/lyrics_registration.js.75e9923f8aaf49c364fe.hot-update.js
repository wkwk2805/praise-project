...
var onSubmitHandler = function onSubmitHandler(data) {
  return axios__WEBPACK_IMPORTED_MODULE_3___default.a.put("http://localhost:3001/api/insert", data).then(function (result) {
    console.log(result);
    return result;
  }).catch(function (e) {
    console.error(e);
...
//# sourceMappingURL=lyrics_registration.js.75e9923f8aaf49c364fe.hot-update.js.map