...
var LyricsList = function LyricsList(_ref) {
  ...
  var downloadFiles = function downloadFiles() {
    ...
    checked.forEach(function (item, i) {
      var name = item.file;
      axios__WEBPACK_IMPORTED_MODULE_6___default()("http://localhost:3001/uploads/".concat(name)).then(function (res) {
    ...
    zip.generateAsync({
      ...
      Object(file_saver__WEBPACK_IMPORTED_MODULE_8__["saveAs"])(content, "exmaple.zip");
    });
  };
...
//# sourceMappingURL=lyrics_list.js.8b596221b4715720683c.hot-update.js.map