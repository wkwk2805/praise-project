...
var LyricsList = function LyricsList(_ref) {
  ...
  var removeLyrics = function removeLyrics(e) {
    ...
    axios__WEBPACK_IMPORTED_MODULE_9___default.a.delete("".concat(_util_hostname__WEBPACK_IMPORTED_MODULE_10__["default"], "/api"), {
      id: id
    }).then(function (res) {
      console.log(res);
    }).catch(function (err) {
...
//# sourceMappingURL=lyrics_list.js.77ab534d46c51c0775c0.hot-update.js.map