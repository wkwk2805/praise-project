...
var LyricsList = function LyricsList(props) {
  ...
  var getInitData = function getInitData() {
    if (lyrics.length === 0) {
      axios__WEBPACK_IMPORTED_MODULE_8___default.a.get("http://localhost:3001/api").then(function (res) {
        setLyrics(res.data);
      }).catch(function (e) {
        console.log(e);
      });
...
//# sourceMappingURL=lyrics_list.js.eda232df7afe00579b43.hot-update.js.map