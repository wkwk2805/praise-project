...
var selectData = function selectData(first, last) {
  return {
    type: SELECT_DATA,
    payload: "get",
    param: [first, last]
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return axiosData(action.payload, parma);
...
//# sourceMappingURL=lyrics_registration.js.33b8298d2742fd8be88b.hot-update.js.map