...
var LyricsList_LyricsList = function LyricsList(_ref) {
  ...
  var inputRef = Object(external_react_["useRef"])(); // init
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 8;
              return external_axios_default.a.get("".concat(hostname["a" /* default */], "/api/scroll?info=").concat(val, "&first=").concat(lyrics.length - 1));
  ...
  var downloadFile = function downloadFile(name) {
    external_axios_default()({
      url: "".concat(hostname["a" /* default */], "/uploads/").concat(name),
      method: "GET",
  ...
  return external_react_default.a.createElement(external_react_default.a.Fragment, null, external_react_default.a.createElement(Layout["a" /* default */], {
    ...
    return external_react_default.a.createElement("div", {
      ...
      src: e.file ? "".concat(hostname["a" /* default */], "/uploads/").concat(e.file) : "./static/no_img.gif",
      style: {
        maxHeight: "200px"
      },
    ...
    className: "jsx-3632274245" + " " + "btn btn-primary"
  }, "\uC545\uBCF4\uB2E4\uC6B4\uB85C\uB4DC")))), external_react_default.a.createElement("div", {
    style: {
      textAlign: "center"
    },
    className: "jsx-3632274245"
    ...
    className: "jsx-3632274245"
  }, isAllData && "모든 악보가 다 나왔습니다."))), external_react_default.a.createElement(style_default.a, {
    id: "3632274245"
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 3;
            return req.query.value ? external_axios_default.a.get(hostname["a" /* default */] + "/api/search?info=" + param) : external_axios_default.a.get(hostname["a" /* default */] + "/api");
