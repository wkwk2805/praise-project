...
var Home = function Home() {
  var keyEvent = function keyEvent(e) {
    console.log(window.encodeURI(e.target.value));

    switch (e.keyCode) {
      case 13:
        e.target.value && (window.location.href = "./lyrics_list?value=" + window.encodeURI(e.target.value));
        return;
    }
  };
...
//# sourceMappingURL=index.js.8e9f4dd9b79e42ef028f.hot-update.js.map