...
var LyricsList = function LyricsList(_ref) {
  ...
  var dispatch = Object(react_redux__WEBPACK_IMPORTED_MODULE_5__["useDispatch"])(); // init
  ...
  var scrollHandler = function scrollHandler() {
    ...
    if (scrollHeight - innerHeight - scrollTop < 100) {
      dispatch(Object(_modules_sagas__WEBPACK_IMPORTED_MODULE_6__["selectData"])()); // 넣어준 값으로 다시 뿌려줄 준비하기
    }
  }; // checkbox event
  ...
  var createPpt = function createPpt() {
    ...
    if (!li || li.length === 0) {
      alert("PPT를 생성할 악보가 없습니다. 악보를 선택해주세요");
      return;
    }

    var str = li.join("");
    str = str.substring(0, str.length - 1);
    next_router__WEBPACK_IMPORTED_MODULE_4___default.a.push("/lyrics_check_view?" + str);
  };
...
//# sourceMappingURL=lyrics_list.js.605a9a92eab6158810ef.hot-update.js.map