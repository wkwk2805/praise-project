...
module.exports = __webpack_require__("LJrg");
...
// CONCATENATED MODULE: ./components/CheckView.js
...
var CheckView_CheckView = function CheckView(_ref) {
  var data = _ref.data,
      id = _ref.id;
  ...
  var open_view = function open_view() {
    ...
    openView = open("./lyrics_view?id=" + stringify_default()(id) + "&init=" + document.getElementsByClassName("active")[0].id.replace(/#/g, "%23"), "_blank", "toolbar=yes,scrollbars=yes,resizable=yes,width=1080,height=800");
    ...
    window.communityMove = function (idx) {
      ...
      try {
        for (var _iterator = get_iterator_default()(cols), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
  ...
  var downloadPpt = function downloadPpt() {
    Object(handler["c" /* onDownloadPpt */])(Object(handler["a" /* arrayHandler */])(lists));
  };
  ...
  return external_react_default.a.createElement(Layout["a" /* default */], {
  ...
  }, "HOME"), " ", external_react_default.a.createElement("i", {
    ...
    className: "jsx-3371871912"
  }, "SHOW VIEW"), " ", external_react_default.a.createElement("i", {
    ...
    className: "jsx-3371871912"
  }, "DOWNLOAD PPT"), " ", external_react_default.a.createElement("i", {
  ...
  }, lists.map(function (e, idx) {
    {
      return e.contents.map(function (item, i) {
        return external_react_default.a.createElement("div", {
        ...
        }, e.title), external_react_default.a.createElement("div", {
          id: idx + "#" + i + "#" + e.id,
          className: "jsx-3371871912"
        }, item.split("\n").map(function (it, i2) {
          return external_react_default.a.createElement("span", {
            ...
            id: idx + "#" + i + "#" + e.id,
            className: "jsx-3371871912"
          }, it, external_react_default.a.createElement("br", {
            className: "jsx-3371871912"
          }));
        })));
      });
...
/* harmony default export */ var components_CheckView = (CheckView_CheckView);
// EXTERNAL MODULE: external "axios"
var external_axios_ = __webpack_require__("zr5I");
var external_axios_default = /*#__PURE__*/__webpack_require__.n(external_axios_);

// CONCATENATED MODULE: ./pages/lyrics_check_view.js
...
var lyrics_check_view_lyrics_check_view = function lyrics_check_view(_ref) {
  var data = _ref.data,
      id = _ref.id;
  return external_react_default.a.createElement(components_CheckView, {
    data: data,
    id: id
  });
...
lyrics_check_view_lyrics_check_view["getInitialProps"] =
/*#__PURE__*/
function () {
    ...
    return regenerator_default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return external_axios_default.a.get("http://localhost:3001/api/choice?id=" + stringify_default()(req.query.id));
...
/* harmony default export */ var pages_lyrics_check_view = __webpack_exports__["default"] = (lyrics_check_view_lyrics_check_view);
