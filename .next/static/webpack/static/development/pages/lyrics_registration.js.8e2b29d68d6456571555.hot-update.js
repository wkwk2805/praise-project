...
var onSubmitHandler = function onSubmitHandler(data) {
  axios__WEBPACK_IMPORTED_MODULE_3___default.a.put("http://localhost:3001/api/insert", data).then(function (result) {
    return result.data;
  }).catch(function (e) {
    console.error(e);
  });
...
//# sourceMappingURL=lyrics_registration.js.8e2b29d68d6456571555.hot-update.js.map