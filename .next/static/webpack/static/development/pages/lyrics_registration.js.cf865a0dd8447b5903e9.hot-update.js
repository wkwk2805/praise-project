...
var submitHandler = function submitHandler(data, dispatch) {
  return {
    type: SUBMIT_HANDLER,
    data: data,
    dispatch: dispatch
...
var lyrics = function lyrics() {
  ...
  switch (action.type) {
    ...
    case SUBMIT_HANDLER:
      return onSubmitHandler(action.data, action.dispatch);
...
var onSubmitHandler = function onSubmitHandler(data, dispatch) {
  axios__WEBPACK_IMPORTED_MODULE_3___default.a.put("http://localhost:3001/api/insert", data).then(function (res) {
    dispatch(resultState(res));
  }).catch(function (e) {
...
//# sourceMappingURL=lyrics_registration.js.cf865a0dd8447b5903e9.hot-update.js.map