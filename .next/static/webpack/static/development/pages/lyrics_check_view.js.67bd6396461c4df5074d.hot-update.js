...
var CheckView = function CheckView(_ref) {
  ...
  var change_data = function change_data(e) {
    if (openView) {
      openView.document.getElementById("data").value = "abc"; //openView.document.getElementById("data").value = JSON.stringify({ main: 1, sub: 1 });
    }
...
//# sourceMappingURL=lyrics_check_view.js.67bd6396461c4df5074d.hot-update.js.map