...
var LyricsList = function LyricsList(_ref) {
  ...
  var downloadFiles = function downloadFiles() {
    ...
    axios__WEBPACK_IMPORTED_MODULE_6___default()({
      url: "http://localhost:3001/api/downloads",
      method: "GET",
      responseType: "base64" // important

    }).then(function (response) {
      var url = window.URL.createObjectURL(new Base64([response.data]));
      var link = document.createElement("a");
      link.href = url;
      link.setAttribute("download", name);
      document.body.appendChild(link);
...
//# sourceMappingURL=lyrics_list.js.91e4a020bd1751bc3d0c.hot-update.js.map