    ...
    return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            admin = false;
            console.log(ctx.req.headers.cookie.indexOf("connect.sid"));

            if (ctx.req.headers.cookie.indexOf("connect.sid") > -1) {
              admin = true;
            }
...
//# sourceMappingURL=lyrics_list.js.22302e1b9b96e8372cdf.hot-update.js.map