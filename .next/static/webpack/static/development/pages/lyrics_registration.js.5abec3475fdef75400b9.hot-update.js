...
var onSubmitHandler = function onSubmitHandler(data, dispatch) {
  return axios__WEBPACK_IMPORTED_MODULE_3___default.a.put("http://localhost:3001/api/insert", data).then(function (res) {
    resultState(res);
  }).catch(function (e) {
...
//# sourceMappingURL=lyrics_registration.js.5abec3475fdef75400b9.hot-update.js.map