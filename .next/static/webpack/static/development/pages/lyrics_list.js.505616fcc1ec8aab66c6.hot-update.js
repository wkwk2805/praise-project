...
var LyricsList = function LyricsList(_ref) {
  ...
  var removeChecked = function removeChecked(e, id) {
    ...
    el.checked = false;
    e.target.parentElement && (e.target.parentElement.outerHTML = ""); //setChecked(checked.filter(e2 => e2.id !== id));
  };
...
//# sourceMappingURL=lyrics_list.js.505616fcc1ec8aab66c6.hot-update.js.map