...
var LyricsList = function LyricsList(_ref) {
  ...
  Object(react__WEBPACK_IMPORTED_MODULE_4__["useEffect"])(function () {
    ...
    if (result && select.length === 0) {
      alert("검색된 내용이 없습니다");
    } else if (scroll && select.length === 0) {
      alert("모든 데이터가 나왔습니다.");
    } else if (scroll && select.length > 0) {
      setLyrics(lyrics.concat(select));
    } else {
      setLyrics(select);
    }
  }, [select]); // scroll event
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              _context.next = 8;
              return dispatch(Object(_modules_sagas__WEBPACK_IMPORTED_MODULE_8__["scrollData"])(lyrics.length - 1));
...
//# sourceMappingURL=lyrics_list.js.24d7b56e370de10d4a42.hot-update.js.map