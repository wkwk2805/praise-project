  ...
  Object(react__WEBPACK_IMPORTED_MODULE_5__["useEffect"])(function () {
    ...
    if (checked instanceof Array && checked.length > 0) {
      checked.forEach(function (item) {
        console.log(item.id);
        var i = document.querySelector("#".concat(item.id));
        console.log(i);
      });
    }
  }, [select]);
...
//# sourceMappingURL=lyrics_list.js.213ee92b3de22e769c7a.hot-update.js.map