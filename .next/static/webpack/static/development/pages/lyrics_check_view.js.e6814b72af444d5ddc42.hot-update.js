...
var CheckView = function CheckView(_ref) {
  ...
  var open_view = function open_view() {
    a = open("./lyrics_view?id=" + _babel_runtime_corejs2_core_js_json_stringify__WEBPACK_IMPORTED_MODULE_1___default()(id), "_blank", "toolbar=yes,scrollbars=yes,resizable=yes,width=1080,height=800");

    a.hello = function () {
      var b = this.document.getElementById(id);
      this.console.log(b);
    };
  };
...
//# sourceMappingURL=lyrics_check_view.js.e6814b72af444d5ddc42.hot-update.js.map