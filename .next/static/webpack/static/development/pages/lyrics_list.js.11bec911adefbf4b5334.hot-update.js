...
var serachAxiosData = function serachAxiosData(info) {
  axios__WEBPACK_IMPORTED_MODULE_2___default.a.get("http://localhost:3001/api/search?info=" + info);
}; // dispatch => checking =>
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _context2.prev = 0;
          _context2.next = 3;
          return serachAxiosData(action.param);
...
//# sourceMappingURL=lyrics_list.js.11bec911adefbf4b5334.hot-update.js.map