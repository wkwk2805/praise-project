...
var CheckView = function CheckView(_ref) {
  ...
  var contentsHandler = function contentsHandler(data) {
    ...
    console.log(arr);
    arr.forEach(function (item) {//arr1 = arr1.concat(item);
    });
    return data;
  };
...
//# sourceMappingURL=lyrics_check_view.js.208e304c85b7f81d9a93.hot-update.js.map