...
var CheckView = function CheckView(_ref) {
  ...
  var change_data = function change_data(e) {
    if (openView) {
      console.log(openView.document.getElementById("data")); //openView.document.getElementById("data").value = JSON.stringify({ main: 1, sub: 1 });
    }
...
//# sourceMappingURL=lyrics_check_view.js.0acd65cd2e88e8adbbb0.hot-update.js.map